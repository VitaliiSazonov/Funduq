      ...
      >
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="mt-auto flex justify-between items-center">
            ...
            <motion.div
              whileHover={{ x: 3 }}
              className="w-11 h-11 rounded-full border border-gold/30 flex items-center justify-center text-gold-dark group-hover:bg-gold group-hover:text-white transition-all duration-300"
            >
