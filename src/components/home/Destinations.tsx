...
const DESTINATIONS = [
  {
    ...
    alt: "Dubai Marina skyline and luxury lifestyle",
    offset: false,
    filterValue: "Dubai",
  },
  {
  ...
  {
    key: "rak",
    image: "https://images.unsplash.com/photo-1707403242352-4f624512b4bb?w=800&q=80",
    alt: "Rocky mountain landscape in Ras Al Khaimah, UAE",
    offset: false,
