...
export default async function AreasIndexPage({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header Section (Dark) so transparent Header is visible */}
      <section className="pt-32 pb-16 px-4 md:px-8 bg-charcoal text-white">
        <div className="max-w-7xl mx-auto w-full">
          <h1 className="text-4xl md:text-5xl font-black display-font mb-6 text-white text-center md:text-left">
            {locale === "ru" ? "Районы Дубая" : "Explore Dubai by Area"}
          </h1>
          <p className="text-lg text-white/70 max-w-3xl leading-relaxed text-center md:text-left">
            {locale === "ru" 
      ...
      {/* Content Section */}
      <section className="py-16 px-4 md:px-8 bg-offwhite flex-grow">
        <div className="max-w-7xl mx-auto w-full">
